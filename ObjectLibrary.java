...
class Module {
    ...
    public void DisplayInfo(boolean nameOnly) {
        ...
        System.out.format("\u001B[" + getColor() + getPre() +" "+name + "\u001B[0m");  // 改为使用getter
        if (!nameOnly) {
            System.out.println(" - Hp: " + getHp() + ", "+ability + getValue() + ", AntiScount: " + getAntiScout());  // 改为使用getter
        }
    }
